...
/**
     ...
     { loadContext    // The loadContext object
...
var MTreeBrick = (function () {
    function MTreeBrick(uri, loadContext) {
    ...
    MTreeBrick.prototype.clone = function() {
        var clonedModel = new MTreeBrick(this.uri, this.loadContext);
        if (this.$params) {
...
function _dumpNodeDeep(node, indent, buffer, ctx) {
    if (ctx.evaluated && node.u) {
        var sourceUri = ctx.loadContext.ittfDocumentDatas[node.u].ittfDocumentUri;
