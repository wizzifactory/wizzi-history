...
var MTreeBrickProvider = (function () {
    ...
    */
    MTreeBrickProvider.prototype.get = function(options, callback) {
        ...
        this.documentFinder.resolvePath(options, function(err, uri) {
            ...
            if (cachedMTreeBrick) {
                ...
                // adding the mTreeBrickCloned to the loadContext
                // generates the sourceKey and brickKey
                var mTreeBrickData = loadContext.addMTreeBrick(uri, that.schema, mTreeBrickCloned, options)
                ;
    ...
    MTreeBrickProvider.prototype.loadMTreeBrickFromSource = function(uri, options, ittfContent, callback) {
        ...
        this.loadContext.addIttfDocument(uri, ittfContent);
        if (this.sourcePreprocessor) {
            // TODO save the preprocessed in productionContext and loadContext
        ...
        var mTreeBrickData = this.loadContext.addMTreeBrick(uri, this.schema, null, options)
        ;
        var newMTreeBrick = new MTreeBrick(uri, this.loadContext);
    ...
    MTreeBrickProvider.prototype.enterFragmentCall = function(mixerUri, mixedUri) {
        this.loadContext.enterFragmentCall(mixerUri, mixedUri);
    }
    MTreeBrickProvider.prototype.exitFragmentCall = function() {
        this.loadContext.exitFragmentCall();
    }
    MTreeBrickProvider.prototype.checkForRecursion = function() {
        return this.loadContext.checkForRecursion();
    }
