/*
    ...
    primary source IttfDocument: c:\my\wizzi\v4\plugins\wizzi-codegen\src\ittf\lib\js_v4\statements\statements.js.ittf
...
md.load = function(cnt) {
    ...
    cnt.stm.xexport = function(model, ctx) {
        if (ctx.__ecma === 'es5') {
            console.log('wizzi-codegen.js2.statements.ecma,jskind', ctx.__ecma, ctx.__jskind);
