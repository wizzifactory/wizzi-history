...
if ( 0 ) 
{
    cd c:\my\wizzi\v6\test\wizzi-scripts\examples\webpack
    node index
}

if ( 0 ) 
{
    cd c:\my\wizzi\v6\test\wizzi-scripts\examples\babelParse
    node index
}

if ( 0 ) 
{
    cd c:\my\wizzi\v6\test\wizzi-scripts\examples\flow
    node index
}

if ( 0 )
{
    cd c:\my\wizzi\v6\test\wizzi-scripts\examples\prettier
    node index
}

if ( 1 ) 
{
    cd c:\my\wizzi\v6\test\wizzi-scripts\examples\eslint
    node index
}

if ( 0 ) 
{
    cd c:\my\wizzi\v6\test\wizzi-scripts\examples\babelTransform
    node index
}
