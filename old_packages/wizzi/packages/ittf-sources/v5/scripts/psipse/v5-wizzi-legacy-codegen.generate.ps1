...
if ( 1 )
{
    ...
    robocopy c:\my\wizzi\v5\legacy\wizzi-legacy-v4-codegen\dist c:\my\wizzi\v5\github\wizzi\packages\wizzi-legacy-v4-codegen /NFL /NDL /NJH /np /MIR /XD .git, node_modules
}
