/*
    ...
    primary source IttfDocument: c:\my\wizzi\v4\plugins\wizzi-codegen\src\ittf\lib\js\util\lineparser.js.ittf
...
md.parseNameValueRaw = function(text, node) {
    ...
    return {
            ...
            value: function() {
                if (quotes.length > 0) {
                    console.log('*=*=*= temporary wizzi-codegen.lineparser. quotes, value: ', quotes, value.join(''));
                    console.log(quotes[0].q, quotes[quotes.length -1].q);
                }
                if (quotes.length > 2 && quotes[0].q === quotes[quotes.length -1].q) {
                    var q = quotes[0].q;
                    ...
                    console.log('*=*=*= temporary wizzi-codegen.lineparser. value: ', value.join(''));
                }
                return value.join('');
            }, 
            hasValue: function() {
