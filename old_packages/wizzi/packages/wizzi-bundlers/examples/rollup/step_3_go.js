/*
    ...
    primary source IttfDocument: c:\my\wizzi\v5\apps\wizzi-bundlers\wizzi\ittf\examples\rollup\step_3_go.js.ittf
*/
'use strict';
...
var rollup_build = function(step_callback) {
    ...
    rollupBundler.makeBundle(path.join(__dirname, 'step_3', 'src', 'main.js.ittf'), {}, function(err, generated) {
        if (err) {
...
function heading1(text) {
    ...
    console.log('** level 1 - step 3 - rollup_build - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
