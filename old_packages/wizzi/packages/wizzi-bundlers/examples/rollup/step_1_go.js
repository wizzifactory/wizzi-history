/*
    ...
    primary source IttfDocument: c:\my\wizzi\v5\apps\wizzi-bundlers\wizzi\ittf\examples\rollup\step_1_go.js.ittf
*/
'use strict';
...
var rollup_build = function(step_callback) {
    heading1('Example rollup_build starting');
    var inputOptions = {
    ...
    function build() {
        console.log('build started', rollup);
        rollup.rollup(inputOptions).then((bundle) => {
            console.log('rollup.imports', bundle.imports);
            console.log('rollup.exports', bundle.exports);
            console.log('rollup.modules', bundle.modules);
            bundle.generate(outputOptions).then((result) => {
                console.log('generate', result);
                bundle.write(outputOptions).then((written) => {
...
rollup_build.__name = 'Level 1 - rollup_build';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 1 - step 1 - rollup_build - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
