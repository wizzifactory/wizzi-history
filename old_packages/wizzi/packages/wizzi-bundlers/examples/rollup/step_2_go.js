/*
    ...
    primary source IttfDocument: c:\my\wizzi\v5\apps\wizzi-bundlers\wizzi\ittf\examples\rollup\step_2_go.js.ittf
*/
'use strict';
...
var rollup_wizzi_build = function(step_callback) {
    heading1('Example rollup_wizzi_build starting');
    rollupBundler.makeBundle(path.join(__dirname, 'step_1', 'src', 'main.js'), {}, function(err, generated) {
        if (err) {
            return callback(err);
        }
        printValue('rollupBundler', generated);
        return step_callback(null);
    });
};
rollup_wizzi_build.__name = 'Level 1 - rollup_wizzi_build';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 1 - step 2 - rollup_wizzi_build - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- rollup_wizzi_build - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = rollup_wizzi_build;
