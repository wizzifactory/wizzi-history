/*
    ...
    primary source IttfDocument: c:\my\wizzi\v5\apps\wizzi-bundlers\wizzi\ittf\examples\webpack\step_3_go.js.ittf
*/
'use strict';
...
var webpack_build = function(step_callback) {
    ...
    webpackBundler.makeBundle(path.join(__dirname, 'step_3', 'src', 'main.js.ittf'), {}, function(err, generated) {
        if (err) {
