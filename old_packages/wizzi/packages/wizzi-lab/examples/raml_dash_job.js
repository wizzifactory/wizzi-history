/*
    ...
    primary source IttfDocument: c:\my\wizzi\v5\plugins\wizzi-lab\src\ittf\examples\raml_dash_job.js.ittf
    utc time: Tue, 14 Aug 2018 20:02:56 GMT
*/
'use strict';
...
function executeExample() {
    executeWizziJob(path.join(__dirname, 'raml', 'ittf', 'dash', 'dash-raml.wfjob.ittf'), [
        'wizzi-lab'
    ]);
}
