...
function loadFromIttfModel(ittfModel,ittfDocumentUri,request,callback) {
    ...
    if ((request.dumpAll || request.dumpModel) && wfpackagemodel.toJson && pathutil.isFilePath(ittfDocumentUri)) {
        // dump for debug
    ...
    wfpackagemodel.wzInitializeAsync(ctx, function(err,result) {
        ...
        if ((request.dumpAll || request.dumpModelAfterInitializeAsync) && wfpackagemodel.toJson && pathutil.isFilePath(ittfDocumentUri)) {
            // dump for debug
