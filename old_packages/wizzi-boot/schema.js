// generator: /wizzi-labs/wizzi-lab-site/ittf/lib/artifacts/js/module/gen/main.js, utc time: Thu, 23 Mar 2017 19:16:29 GMT
'use strict';
...
*/
md.executeWizziModelTypesGeneration = function(wizzischemaIttfDocumentUri,modelPath,factoryPath,testPath,jsondocsPath,htmldocsPath,context,callback) {
    md.generateWizziModelObjects(wizzischemaIttfDocumentUri, context || {}, function(err,wizziModelAndFactoryArtifact) {
        if (err) {
...
/**
     ...
     from an IttfDocument of schema "wizzischema"
*/
md.generateWizziModelObjects = function(wizzischemaIttfDocumentUri,context,callback) {
    ...
    md.wizzischema(wizzischemaIttfDocumentUri, context, function(err,schemaModelTemp) {
        ...
        md.doArtifactGeneration(bootWizziModel, bootModelDefUri, 'wizzischema/model', context, function(err,wizziModelArtifact) {
            ...
            // execute the artifact generator 'wizzischema/factory'
            md.doArtifactGeneration(bootWizziModel, bootModelDefUri, 'wizzischema/factory', context, function(err,wizziFactoryArtifact) {
                if (err) {
                    return callback(err);
                }
