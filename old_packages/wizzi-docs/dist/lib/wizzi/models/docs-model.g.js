...
var docsBase = (function () {
    ...
    docsBase.prototype.error = function(message,node) {
        throw new md.docsModelException(message, node, this);
    }
...
var docs = (function (docsBase) {
    ...
    docs.prototype.toJsonProperties = function(result) {
        md.docsBase.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
    ...
    docs.prototype.toJsonChildren = function(result) {
        md.docsBase.prototype.toJsonChildren.call(this, result);
        var items, item;
        items = [];
    ...
    docs.prototype.loadChild = function(child) {
        ...
        if (_l == 1 && _ch == '+') {
            if (name === '+') {
                return this.wzLoadToChildColl(child, md.plus, this.items);
            }
        }
        if (_l == 1 && _ch == '-') {
            if (name === '-') {
                return this.wzLoadToChildColl(child, md.ittfnode, this.items);
            }
        }
        if (_l == 1 && _ch == '<') {
            if (name === '<') {
                return this.wzLoadToChildColl(child, md.element, this.items);
            }
        }
        if (_l == 1 && _ch == '@') {
            if (name === '@') {
                return this.wzLoadToChildColl(child, md.attribute, this.items);
            }
        }
        if (_l == 1 && _ch == 'a') {
            if (name === 'a') {
                return this.wzLoadToChildColl(child, md.a, this.items);
            }
        }
        if (_l == 1 && _ch == 'p') {
            if (name === 'p') {
                return this.wzLoadToChildColl(child, md.p, this.items);
            }
        }
        if (_l == 2 && _ch == 'b') {
            if (name === 'br') {
                return this.wzLoadToChildColl(child, md.br, this.items);
            }
        }
        if (_l == 2 && _ch == 'h') {
            if (name === 'hr') {
                return this.wzLoadToChildColl(child, md.hr, this.items);
            }
            else if (name === 'h1') {
                return this.wzLoadToChildColl(child, md.h1, this.items);
            }
            else if (name === 'h2') {
                return this.wzLoadToChildColl(child, md.h2, this.items);
            }
            else if (name === 'h3') {
                return this.wzLoadToChildColl(child, md.h3, this.items);
            }
            else if (name === 'h4') {
                return this.wzLoadToChildColl(child, md.h4, this.items);
            }
            else if (name === 'h5') {
                return this.wzLoadToChildColl(child, md.h5, this.items);
            }
            else if (name === 'h6') {
                return this.wzLoadToChildColl(child, md.h6, this.items);
            }
        }
        if (_l == 2 && _ch == 'j') {
            if (name === 'js') {
                return this.wzLoadToChildColl(child, md.js, this.items);
            }
        }
        if (_l == 2 && _ch == 'l') {
            if (name === 'li') {
                return this.wzLoadToChildColl(child, md.li, this.items);
            }
        }
        if (_l == 2 && _ch == 't') {
            if (name === 'th') {
                return this.wzLoadToChildColl(child, md.th, this.items);
            }
            else if (name === 'tr') {
                return this.wzLoadToChildColl(child, md.tr, this.items);
            }
            else if (name === 'td') {
                return this.wzLoadToChildColl(child, md.td, this.items);
            }
        }
        if (_l == 2 && _ch == 'u') {
            if (name === 'ul') {
                return this.wzLoadToChildColl(child, md.ul, this.items);
            }
        }
        if (_l == 3 && _ch == 'd') {
            if (name === 'div') {
                return this.wzLoadToChildColl(child, md.div, this.items);
            }
        }
        if (_l == 3 && _ch == 's') {
            if (name === 'see') {
                return this.wzLoadToChildColl(child, md.see, this.items);
            }
        }
        if (_l == 4 && _ch == 'a') {
            if (name === 'apim') {
                return this.wzLoadToChildColl(child, md.apiMethod, this.items);
            }
        }
        if (_l == 4 && _ch == 'i') {
            if (name === 'ittf') {
                return this.wzLoadToChildColl(child, md.ittf, this.items);
            }
        }
        if (_l == 4 && _ch == 's') {
            if (name === 'span') {
                return this.wzLoadToChildColl(child, md.span, this.items);
            }
        }
        if (_l == 4 && _ch == 't') {
            if (name === 'todo') {
                return this.wzLoadToChildColl(child, md.todo, this.items);
            }
            else if (name === 'tags') {
                return this.wzLoadToChildColl(child, md.tags, this.items);
            }
        }
        if (_l == 5 && _ch == 'a') {
            if (name === 'api-m') {
        ...
        if (_l == 5 && _ch == 'i') {
            if (name === 'issue') {
                return this.wzLoadToChildColl(child, md.issue, this.items);
            }
            else if (name === 'intro') {
                return this.wzLoadToChildColl(child, md.intro, this.items);
            }
        }
        if (_l == 5 && _ch == 't') {
            if (name === 'table') {
                return this.wzLoadToChildColl(child, md.table, this.items);
            }
            else if (name === 'tbody') {
                return this.wzLoadToChildColl(child, md.tbody, this.items);
            }
        }
        if (_l == 6 && _ch == 'o') {
            if (name === 'object') {
                return this.wzLoadToChildColl(child, md.object, this.items);
            }
        }
        if (_l == 6 && _ch == 's') {
            if (name === 'sample') {
                return this.wzLoadToChildColl(child, md.sample, this.items);
            }
        }
        if (_l == 7 && _ch == 'c') {
            if (name === 'concept') {
                return this.wzLoadToChildColl(child, md.concept, this.items);
            }
        }
        if (_l == 7 && _ch == 'p') {
            if (name === 'project') {
                return this.wzLoadToChildColl(child, md.project, this.items);
            }
        }
        if (_l == 7 && _ch == 'r') {
            if (name === 'roadmap') {
                return this.wzLoadToChildColl(child, md.roadmap, this.items);
            }
        }
        if (_l == 7 && _ch == 's') {
            if (name === 'section') {
                return this.wzLoadToChildColl(child, md.section, this.items);
            }
            else if (name === 'summary') {
                return this.wzLoadToChildColl(child, md.summary, this.items);
            }
        }
        if (_l == 8 && _ch == 'a') {
            if (name === 'apiparam') {
                return this.wzLoadToChildColl(child, md.apiParam, this.items);
            }
        }
        if (_l == 9 && _ch == 'a') {
            if (name === 'apiobject') {
                return this.wzLoadToChildColl(child, md.apiObject, this.items);
            }
        ...
        if (_l == 9 && _ch == 'm') {
            if (name === 'milestone') {
                return this.wzLoadToChildColl(child, md.milestone, this.items);
            }
        }
        if (_l == 10 && _ch == 'a') {
            if (name === 'api-object') {
        ...
        if (_l == 10 && _ch == 'c') {
            if (name === 'categories') {
                return this.wzLoadToChildColl(child, md.categories, this.items);
            }
        }
        if (_l == 11 && _ch == 's') {
            if (name === 'samplegroup') {
                return this.wzLoadToChildColl(child, md.sampleGroup, this.items);
            }
        }
        if (_l == 12 && _ch == 's') {
    ...
    docs.prototype.loadFromNode = function(node) {
        ...
        for (i=0; i<i_len; i++) {
            ...
            if (!loaded) {
                throw new md.docsModelException("Tag not recognized: " + item.n, item, this);
            }
        }
    }
    docs.prototype.wzVerify = function(ctx) {
        ...
        md.docsBase.prototype.wzVerify.call(this, ctx);
    }
    docs.prototype.wzInitialize = function(ctx) {
        ...
        md.docsBase.prototype.wzInitialize.call(this, ctx);
    }
    return docs;
})(docsBase);
...
md.ittfnode = ittfnode;
md.__tagElementMapping = { '<': 'element', '@': 'attribute', '+': 'plus', 'api-object': 'apiObject', 'apiobject': 'apiObject', 'api-m': 'apiMethod', 'apim': 'apiMethod', 'api-param': 'apiParam', 'apiparam': 'apiParam', 'sample-group': 'sampleGroup', 'samplegroup': 'sampleGroup', '-': 'ittfnode' };
...
md.docsModelException = docsModelException;
