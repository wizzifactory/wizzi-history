/*
    ...
    primary source IttfDocument: c:\my\wizzi\v4\plugins\wizzi-docs\src\ittf\lib\artifacts\docs\preprint\trans\htmlwriter.js.ittf
...
var HtmlWriter = (function () {
    ...
    HtmlWriter.prototype.writeElement = function(node) {
        ...
        var i, i_len=node.attribs.length, a;
        for (i=0; i<i_len; i++) {
            a = node.attribs[i];
        ...
        if (node.children.length > 0) {
            this.sw.w();
            this.sw.indent();
            var i, i_len=node.children.length, e;
            for (i=0; i<i_len; i++) {
                e = node.children[i];
                this.writeElement(e);
            }
