/*
    ...
    primary source IttfDocument: c:\my\wizzi\v4\plugins\wizzi-docs\src\ittf\lib\artifacts\docs\preprint\trans\htmlbuilder.js.ittf
...
var HtmlBuilder = (function () {
    ...
    HtmlBuilder.prototype.toLines = function() {
        ...
        var i, i_len=this.nodes.length, node;
        for (i=0; i<i_len; i++) {
            node = this.nodes[i];
