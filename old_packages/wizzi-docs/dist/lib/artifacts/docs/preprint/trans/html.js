/*
    ...
    primary source IttfDocument: c:\my\wizzi\v4\plugins\wizzi-docs\src\ittf\lib\artifacts\docs\preprint\trans\html.js.ittf
...
md.element = function(model, ctx, parent) {
    var nv = lineparser.parseNameValueRaw(model.wzName);
    var tag = nv.name();
...
function setAttributes(model, ctx) {
    ...
    var i, i_len=model.attributes.length, a;
    for (i=0; i<i_len; i++) {
        a = model.attributes[i];
        var nv = lineparser.parseNameValueRaw(a.wzName);
