/*
    ...
    primary source IttfDocument: c:\my\wizzi\v5\plugins\wizzi-codegen\src\ittf\lib\js_v4\statements\jsonstatementtree.js.ittf
*/
'use strict';
...
function normalizeJSTNode(node, parent) {
    if (node.n === 'function') {
        console.log('normalizeJSTNode', node);
        node.paramNames = [];
    }
    ...
    for (i=0; i<i_len; i++) {
        ...
        if (node.n === 'function' && item.wzElement === 'param') {
