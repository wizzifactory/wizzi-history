/*
    ...
    primary source IttfDocument: c:\my\wizzi\v5\plugins\wizzi-codegen\src\ittf\lib\js_v4\statements\html.js.ittf
*/
'use strict';
...
md.load = function(cnt) {
    ...
    var i, i_items=html_supported_events, i_len=html_supported_events.length, item;
    for (i=0; i<i_len; i++) {
    ...
    var i, i_items=html_supported_tags, i_len=html_supported_tags.length, item;
    for (i=0; i<i_len; i++) {
