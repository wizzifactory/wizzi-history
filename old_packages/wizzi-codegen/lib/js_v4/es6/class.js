/*
    ...
    primary source IttfDocument: c:\my\wizzi\v5\plugins\wizzi-codegen\src\ittf\lib\js_v4\es6\class.js.ittf
*/
'use strict';
...
var myname = 'wizzi.codegen.js4.es2015.class';
md.gen = function(model, ctx) {
    ...
    if (ctor) {
        ...
        var i, i_items=ctor.statements, i_len=ctor.statements.length, item;
        for (i=0; i<i_len; i++) {
    ...
    ctx.w('');
    var i, i_items=model.statements, i_len=model.statements.length, member;
    for (i=0; i<i_len; i++) {
