/*
    ...
    primary source IttfDocument: c:\my\wizzi\v4\kernel\wizzi-utils\src\ittf\lib\verify.js.ittf
...
md.isEmails = function(value) {
    ...
    var i, i_len=_toArray(value).length, item;
    for (i=0; i<i_len; i++) {
