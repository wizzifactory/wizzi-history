/*
    ...
    primary source IttfDocument: c:\my\wizzi\v5\apps\wizzi-demo\src\ittf\examples\starter\essentials\languageschemas\vue\level_0\step_4_go.js.ittf
*/
'use strict';
...
function heading1(text) {
    ...
    console.log('** level 0 - step 4 - language_schema_vue - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
...
module.exports = function exec(step_callback) {
    ...
    /**
         DEMO: component coded in 'vue' wizzi language schema
    */
    heading1('starting step 4 module_1.vue.ittf');
    wizzi.gen(path.join(__dirname, 'step_4', 'module_1.vue.ittf'), {}, {
        globalContext: {}, 
        artifactContext: {}, 
        ...
        var dest = path.join(__dirname, 'step_4', 'outputs', verify.stripExtension('module_1.vue.ittf'));
        wizzi.file.write(dest, artifactText);
        console.log(verify.stripExtension('module_1.vue.ittf') + ' saved to ' + dest);
