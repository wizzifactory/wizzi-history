/*
    ...
    primary source IttfDocument: c:\my\wizzi\v5\apps\wizzi-demo\src\ittf\examples\starter\essentials\languageschemas\vue\level_0\step_3_go.js.ittf
*/
'use strict';
...
module.exports = function exec(step_callback) {
    ...
    */
    heading1('starting step 3 react_1.vue.ittf');
    wizzi.gen(path.join(__dirname, 'step_3', 'react_1.vue.ittf'), {}, {
        globalContext: {}, 
        artifactContext: {}, 
        ...
        var dest = path.join(__dirname, 'step_3', 'outputs', verify.stripExtension('react_1.vue.ittf'));
        wizzi.file.write(dest, artifactText);
        console.log(verify.stripExtension('react_1.vue.ittf') + ' saved to ' + dest);
