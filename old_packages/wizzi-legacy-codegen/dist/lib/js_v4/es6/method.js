/*
    ...
    primary source IttfDocument: c:\my\wizzi\v4\plugins\wizzi-codegen\src\ittf\lib\js_v4\es6\method.js.ittf
    utc time: Wed, 11 Oct 2017 11:02:31 GMT
*/
'use strict';
var statement = require('../statement');
var md = module.exports = {};
var myname = 'wizzi.codegen.js.es2015.method';
md.gen = function(model, ctx) {
    var method = model.wzName;
    if (model.static) {
        ctx.w('static ' + method + '(' + model.paramNames.join(', ') + ') {');
    }
    else {
