/*
    ...
    primary source IttfDocument: C:\My\wizzi\v2\sources\wizzi-2-boot\ittf\root\examples.js.ittf
...
md.execute = function() {
    md.executeWizziFactoryJob(path.join(__dirname, 'examples', 'js', 'js-examples.wfjob.ittf')
    );
    md.executeWizziFactoryJob(path.join(__dirname, 'examples', 'css', 'css-examples.wfjob.ittf')
    );
    md.executeWizziFactoryJob(path.join(__dirname, 'examples', 'html', 'html-examples.wfjob.ittf')
    );
};
