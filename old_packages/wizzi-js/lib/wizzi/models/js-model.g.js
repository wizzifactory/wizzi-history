...
var jsBase = (function () {
    ...
    jsBase.prototype.error = function(message, node) {
        throw new md.jsModelException(message, node, this);
    }
...
var statement = (function (jsBase) {
    ...
    statement.prototype.toJsonProperties = function(result) {
        md.jsBase.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
    ...
    statement.prototype.toJsonChildren = function(result) {
        md.jsBase.prototype.toJsonChildren.call(this, result);
        var items, item;
        items = [];
    ...
    statement.prototype.loadChild = function(child) {
        ...
        if (_l == 1 && _ch == ':') {
            if (name === ':') {
                return this.wzLoadToChildColl(child, md.namedCallParam, this.statements);
            }
        }
        if (_l == 1 && _ch == '<') {
            if (name === '<') {
        ...
        if (_l == 4 && _ch == 'p') {
            if (name === 'plus') {
                ...
                return this.wzLoadToChildColl(child, md.prop, this.statements);
            }
            else if (name === 'path') {
        ...
        if (_l == 5 && _ch == 's') {
            if (name === 'state') {
                return this.wzLoadToChildColl(child, md.state, this.statements);
            }
            else if (name === 'small') {
        ...
        if (_l == 6 && _ch == 'm') {
            if (name === 'module') {
                return this.wzLoadToChildColl(child, md.module, this.statements);
            }
            else if (name === 'marker') {
        ...
        if (_l == 6 && _ch == 'r') {
            if (name === 'return') {
                ...
                return this.wzLoadToChildColl(child, md.reactFunction, this.statements);
            }
            else if (name === 'render') {
                return this.wzLoadToChildColl(child, md.render, this.statements);
            }
        }
        if (_l == 6 && _ch == 's') {
            if (name === 'switch') {
        ...
        if (_l == 7 && _ch == 'r') {
            if (name === 'require') {
                return this.wzLoadToChildColl(child, md.xrequire, this.statements);
            }
        ...
        if (_l == 8 && _ch == 'd') {
            if (name === 'didmount') {
                return this.wzLoadToChildColl(child, md.didMount, this.statements);
            }
        ...
        if (_l == 8 && _ch == 's') {
            if (name === 'setstate') {
                return this.wzLoadToChildColl(child, md.setState, this.statements);
            }
        }
        if (_l == 8 && _ch == 't') {
            if (name === 'template') {
        ...
        if (_l == 9 && _ch == 'd') {
            if (name === 'did-mount') {
                ...
                return this.wzLoadToChildColl(child, md.didUpdate, this.statements);
            }
        }
        if (_l == 9 && _ch == 'f') {
            if (name === 'function*') {
        ...
        if (_l == 9 && _ch == 'w') {
            if (name === 'willmount') {
                return this.wzLoadToChildColl(child, md.willMount, this.statements);
            }
        ...
        if (_l == 10 && _ch == 'w') {
            if (name === 'wzfunction') {
                ...
                return this.wzLoadToChildColl(child, md.willUpdate, this.statements);
            }
        ...
        if (_l == 11 && _ch == 'w') {
            if (name === 'wz-function') {
                ...
                return this.wzLoadToChildColl(child, md.willUnmount, this.statements);
            }
        ...
        if (_l == 12 && _ch == 'g') {
            if (name === 'graphqlquery') {
                return this.wzLoadToChildColl(child, md.graphqlQuery, this.statements);
            }
        }
        if (_l == 12 && _ch == 'm') {
        ...
        if (_l == 12 && _ch == 's') {
            if (name === 'shouldupdate') {
                return this.wzLoadToChildColl(child, md.shouldUpdate, this.statements);
            }
        }
        if (_l == 12 && _ch == 'w') {
        ...
        if (_l == 15 && _ch == 'g') {
            if (name === 'graphqlmutation') {
                return this.wzLoadToChildColl(child, md.graphqlMutation, this.statements);
            }
        }
        if (_l == 15 && _ch == 'o') {
        ...
        if (_l == 16 && _ch == 'w') {
            if (name === 'willreceiveprops') {
                return this.wzLoadToChildColl(child, md.willReceiveProps, this.statements);
            }
        }
        if (_l == 18 && _ch == 'o') {
    ...
    statement.prototype.loadFromNode = function(node) {
        ...
        for (i=0; i<i_len; i++) {
            ...
            if (!loaded) {
                throw new md.jsModelException("Tag not recognized: " + item.n, item, this);
            }
        }
    }
...
var param = (function (jsBase) {
    ...
    param.prototype.loadChild = function(child) {
        ...
        if (_l == 5 && _ch == 'o') {
            if (name === 'oneof') {
                return this.wzLoadToChildColl(child, md.oneOf, this.facets);
            }
        }
        if (_l == 5 && _ch == 'r') {
            if (name === 'range') {
                return this.wzLoadToChildColl(child, md.rangeFacet, this.facets);
            }
        }
        if (_l == 6 && _ch == 'o') {
            if (name === 'one-of') {
        ...
        if (_l == 7 && _ch == 'a') {
            if (name === 'arrayof') {
                return this.wzLoadToChildColl(child, md.arrayOf, this.facets);
            }
        }
        if (_l == 8 && _ch == 'a') {
            if (name === 'array-of') {
        ...
        if (_l == 8 && _ch == 'r') {
            if (name === 'restrict') {
                return this.wzLoadOneToOne(child, md.restrict, 'restrict');
            }
        }
        if (_l == 9 && _ch == 'm') {
            if (name === 'maxlength') {
        ...
        if (_l == 9 && _ch == 'o') {
            if (name === 'oneoftype') {
                return this.wzLoadToChildColl(child, md.oneOfType, this.facets);
            }
        }
        if (_l == 10 && _ch == 'i') {
            if (name === 'instanceof') {
                return this.wzLoadToChildColl(child, md.instanceOf, this.facets);
            }
        }
        if (_l == 10 && _ch == 'm') {
            if (name === 'max-length') {
...
var stringParam = (function (param) {
    ...
    stringParam.prototype.toJsonProperties = function(result) {
        md.param.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
            }
    ...
    stringParam.prototype.toJsonChildren = function(result) {
        md.param.prototype.toJsonChildren.call(this, result);
    }
    return stringParam;
})(param);

md.stringParam = stringParam;
...
md.functionParam = functionParam;
/**
    element symbolParam
     react param
*/
...
var callbackParam = (function (param) {
    ...
    callbackParam.prototype.loadChild = function(child) {
        ...
        if (_l == 1 && _ch == '[') {
            if (name === '[') {
                return this.wzLoadToChildColl(child, md.arrayParam, this.params);
            }
        }
        if (_l == 1 && _ch == '{') {
            if (name === '{') {
                return this.wzLoadToChildColl(child, md.objectParam, this.params);
            }
        }
        if (_l == 3 && _ch == 'a') {
            if (name === 'any') {
                return this.wzLoadToChildColl(child, md.anyParam, this.params);
            }
        }
        if (_l == 4 && _ch == 'd') {
            if (name === 'date') {
                return this.wzLoadToChildColl(child, md.dateParam, this.params);
            }
        }
        if (_l == 4 && _ch == 'f') {
            if (name === 'func') {
                return this.wzLoadToChildColl(child, md.functionParam, this.params);
            }
        }
        if (_l == 4 && _ch == 'n') {
            if (name === 'node') {
                return this.wzLoadToChildColl(child, md.nodeParam, this.params);
            }
        }
        if (_l == 5 && _ch == 'e') {
            if (name === 'exact') {
                return this.wzLoadToChildColl(child, md.exactParam, this.params);
            }
        }
        if (_l == 5 && _ch == 'o') {
            if (name === 'oneof') {
                return this.wzLoadToChildColl(child, md.oneOfParam, this.params);
            }
        }
        if (_l == 5 && _ch == 'p') {
            if (name === 'param') {
        ...
        if (_l == 5 && _ch == 's') {
            if (name === 'shape') {
                return this.wzLoadToChildColl(child, md.shapeParam, this.params);
            }
        }
        if (_l == 6 && _ch == 'n') {
            if (name === 'number') {
                return this.wzLoadToChildColl(child, md.numberParam, this.params);
            }
        }
        if (_l == 6 && _ch == 'o') {
            if (name === 'one-of') {
        ...
        if (_l == 6 && _ch == 's') {
            if (name === 'string') {
                return this.wzLoadToChildColl(child, md.stringParam, this.params);
            }
            else if (name === 'symbol') {
                return this.wzLoadToChildColl(child, md.symbolParam, this.params);
            }
        }
        if (_l == 7 && _ch == 'b') {
            if (name === 'boolean') {
                return this.wzLoadToChildColl(child, md.booleanParam, this.params);
            }
        }
        if (_l == 7 && _ch == 'e') {
            if (name === 'element') {
                return this.wzLoadToChildColl(child, md.elementParam, this.params);
            }
        }
        if (_l == 8 && _ch == 'c') {
            if (name === 'callback') {
                return this.wzLoadToChildColl(child, md.callbackParam, this.params);
            }
        }
        if (_l == 9 && _ch == 'o') {
            if (name === 'oneoftype') {
                return this.wzLoadToChildColl(child, md.oneOfTypeParam, this.params);
            }
        }
        if (_l == 11 && _ch == 'o') {
            if (name === 'one-of-type') {
        ...
        if (_l == 15 && _ch == 'o') {
            if (name === 'optionscallback') {
                return this.wzLoadToChildColl(child, md.optionsCallbackParam, this.params);
            }
        }
        if (_l == 16 && _ch == 'o') {
        ...
        ok = md.param.prototype.loadChild.call(this, child);
        return ok;
    }
    ...
    callbackParam.prototype.wzVerify = function(ctx) {
        ...
        md.param.prototype.wzVerify.call(this, ctx);
    }
    callbackParam.prototype.wzInitialize = function(ctx) {
        ...
        md.param.prototype.wzInitialize.call(this, ctx);
    }
    return callbackParam;
})(param);

md.callbackParam = callbackParam;
...
md.optionsCallbackParam = optionsCallbackParam;
// element arrayParam
...
var oneOfParam = (function (param) {
    ...
    oneOfParam.prototype.addJsPropertyOrValue = function(name, sourceLineInfo) {
        var retval = new md.jsPropertyOrValue(name, sourceLineInfo);
        retval.wzParent = this;
    ...
    oneOfParam.prototype.loadChild = function(child) {
        ...
        if (_l == 1 && _ch == '@') {
            if (name === '@') {
                return this.wzLoadToChildColl(child, md.jsPropertyOrValue, this.jsPropertyOrValues);
            }
        }
        ok = md.param.prototype.loadChild.call(this, child);
        return ok;
...
md.oneOfTypeParam = oneOfTypeParam;
// element shapeParam
var shapeParam = (function (param) {
    ...
    shapeParam.prototype.addProp = function(name, sourceLineInfo) {
        var retval = new md.prop(name, sourceLineInfo);
        retval.wzParent = this;
    ...
    shapeParam.prototype.loadChild = function(child) {
        ...
        if (_l == 4 && _ch == 'p') {
            if (name === 'prop') {
                return this.wzLoadToChildColl(child, md.prop, this.props);
            }
        }
        ok = md.param.prototype.loadChild.call(this, child);
        return ok;
...
var enumFacet = (function (facet) {
    ...
    enumFacet.prototype.toJsonProperties = function(result) {
        md.facet.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
            }
    ...
    enumFacet.prototype.toJsonChildren = function(result) {
        md.facet.prototype.toJsonChildren.call(this, result);
    }
    return enumFacet;
})(facet);
...
var rangeFacet = (function (facet) {
    ...
    rangeFacet.prototype.loadChild = function(child) {
        ...
        ok = md.facet.prototype.loadChild.call(this, child);
        return ok;
    }
    ...
    rangeFacet.prototype.wzInitialize = function(ctx) {
        ...
        md.facet.prototype.wzInitialize.call(this, ctx);
    }
    return rangeFacet;
})(facet);

md.rangeFacet = rangeFacet;
/**
    element regexpFacet
...
md.namedCallParam = namedCallParam;
/**
...
var iife = (function (xfunction) {
    ...
    iife.prototype.toJsonProperties = function(result) {
        md.xfunction.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
            }
    ...
    iife.prototype.toJsonChildren = function(result) {
        md.xfunction.prototype.toJsonChildren.call(this, result);
    }
...
var macro = (function (statement) {
    ...
    macro.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    macro.prototype.toJsonProperties = function(result) {
        md.statement.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    macro.prototype.toJsonChildren = function(result) {
        md.statement.prototype.toJsonChildren.call(this, result);
    }
    return macro;
})(statement);
...
md.reactFunction = reactFunction;
// element prop
var prop = (function (statement) {
    ...
    prop.prototype.loadChild = function(child) {
        ...
        if (_l == 1 && _ch == '[') {
            if (name === '[') {
                return this.wzLoadOneToOne(child, md.arrayParam, 'param');
            }
        }
        if (_l == 1 && _ch == '{') {
            if (name === '{') {
                return this.wzLoadOneToOne(child, md.objectParam, 'param');
            }
        }
        if (_l == 3 && _ch == 'a') {
            if (name === 'any') {
                return this.wzLoadOneToOne(child, md.anyParam, 'param');
            }
        }
        if (_l == 4 && _ch == 'd') {
            if (name === 'date') {
                return this.wzLoadOneToOne(child, md.dateParam, 'param');
            }
        }
        if (_l == 4 && _ch == 'f') {
            if (name === 'func') {
                return this.wzLoadOneToOne(child, md.functionParam, 'param');
            }
        }
        if (_l == 4 && _ch == 'n') {
            if (name === 'node') {
                return this.wzLoadOneToOne(child, md.nodeParam, 'param');
            }
        }
        if (_l == 5 && _ch == 'e') {
            if (name === 'exact') {
                return this.wzLoadOneToOne(child, md.exactParam, 'param');
            }
        }
        if (_l == 5 && _ch == 'o') {
            if (name === 'oneof') {
                return this.wzLoadOneToOne(child, md.oneOfParam, 'param');
            }
        }
        if (_l == 5 && _ch == 'p') {
            if (name === 'param') {
                return this.wzLoadOneToOne(child, md.param, 'param');
            }
        }
        if (_l == 5 && _ch == 's') {
            if (name === 'shape') {
                return this.wzLoadOneToOne(child, md.shapeParam, 'param');
            }
        }
        if (_l == 6 && _ch == 'n') {
            if (name === 'number') {
                return this.wzLoadOneToOne(child, md.numberParam, 'param');
            }
        }
        if (_l == 6 && _ch == 'o') {
            if (name === 'one-of') {
        ...
        if (_l == 6 && _ch == 's') {
            if (name === 'string') {
                return this.wzLoadOneToOne(child, md.stringParam, 'param');
            }
            else if (name === 'symbol') {
                return this.wzLoadOneToOne(child, md.symbolParam, 'param');
            }
        }
        if (_l == 7 && _ch == 'b') {
            if (name === 'boolean') {
                return this.wzLoadOneToOne(child, md.booleanParam, 'param');
            }
        }
        if (_l == 7 && _ch == 'd') {
            if (name === 'default') {
        ...
        if (_l == 7 && _ch == 'e') {
            if (name === 'element') {
                return this.wzLoadOneToOne(child, md.elementParam, 'param');
            }
        }
        if (_l == 8 && _ch == 'c') {
            if (name === 'callback') {
                return this.wzLoadOneToOne(child, md.callbackParam, 'param');
            }
        }
        if (_l == 8 && _ch == 'r') {
            if (name === 'required') {
        ...
        if (_l == 9 && _ch == 'o') {
            if (name === 'oneoftype') {
                return this.wzLoadOneToOne(child, md.oneOfTypeParam, 'param');
            }
        }
        if (_l == 11 && _ch == 'o') {
            if (name === 'one-of-type') {
        ...
        if (_l == 15 && _ch == 'o') {
            if (name === 'optionscallback') {
                return this.wzLoadOneToOne(child, md.optionsCallbackParam, 'param');
            }
        }
        if (_l == 16 && _ch == 'o') {
            if (name === 'options-callback') {
...
var state = (function (reactMember) {
    ...
    state.prototype.toJsonProperties = function(result) {
        md.reactMember.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
            }
    ...
    state.prototype.toJsonChildren = function(result) {
        md.reactMember.prototype.toJsonChildren.call(this, result);
    }
    return state;
})(reactMember);
...
md.willReceiveProps = willReceiveProps;
// element htmlevent
...
var onCopy = (function (htmlevent) {
    ...
    onCopy.prototype.toJsonProperties = function(result) {
        md.htmlevent.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
            }
    ...
    onCopy.prototype.toJsonChildren = function(result) {
        md.htmlevent.prototype.toJsonChildren.call(this, result);
    }
    return onCopy;
})(htmlevent);
...
var doctype = (function (htmlelement) {
    ...
    doctype.prototype.toJsonProperties = function(result) {
        md.htmlelement.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
            }
    ...
    doctype.prototype.toJsonChildren = function(result) {
        md.htmlelement.prototype.toJsonChildren.call(this, result);
    }
    return doctype;
})(htmlelement);
...
var wzIife = (function (iife) {
    ...
    wzIife.prototype.toJsonProperties = function(result) {
        md.iife.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
            }
    ...
    wzIife.prototype.toJsonChildren = function(result) {
        md.iife.prototype.toJsonChildren.call(this, result);
    }
    return wzIife;
})(iife);
...
var wzVar = (function (xvar) {
    ...
    wzVar.prototype.toJsonProperties = function(result) {
        md.xvar.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
            }
    ...
    wzVar.prototype.toJsonChildren = function(result) {
        md.xvar.prototype.toJsonChildren.call(this, result);
    }
    return wzVar;
})(xvar);
...
var wzConst = (function (xconst) {
    ...
    wzConst.prototype.toJsonProperties = function(result) {
        md.xconst.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
            }
    ...
    wzConst.prototype.toJsonChildren = function(result) {
        md.xconst.prototype.toJsonChildren.call(this, result);
    }
    return wzConst;
})(xconst);
...
var wzClass = (function (xclass) {
    ...
    wzClass.prototype.toJsonProperties = function(result) {
        md.xclass.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
            }
    ...
    wzClass.prototype.toJsonChildren = function(result) {
        md.xclass.prototype.toJsonChildren.call(this, result);
    }
    return wzClass;
})(xclass);
...
md.graphqlMutation = graphqlMutation;
/**
    element log
     ittf:
     log 'xxx', yyy, ...
...
md.jsModelException = jsModelException;
