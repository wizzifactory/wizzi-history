...
var htmlBase = (function () {
    ...
    htmlBase.prototype.error = function(message,node) {
        throw new md.htmlModelException(message, node, this);
    }
    return htmlBase;
})();
...
var element = (function (htmlBase) {
    ...
    element.prototype.loadFromNode = function(node) {
        ...
        for (i=0; i<i_len; i++) {
            ...
            if (!loaded) {
                throw new md.htmlModelException("Tag not recognized: " + item.n, item, this);
            }
        }
    }
...
md.htmlModelException = htmlModelException;
