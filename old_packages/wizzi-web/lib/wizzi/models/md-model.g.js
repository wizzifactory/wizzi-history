...
var md = (function (mdBase) {
    ...
    md.prototype.loadChild = function(child) {
        ...
        if (_l == 1 && _ch == '@') {
            if (name === '@') {
                return this.wzLoadToChildColl(child, _md.propertyOrValue, this.elements);
            }
        }
        if (_l == 1 && _ch == 'a') {
            if (name === 'a') {
...
// element propertyOrValue
var propertyOrValue = (function (element) {
    _inherits(propertyOrValue, element);
    function propertyOrValue(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(propertyOrValue.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, propertyOrValue);
        this.wzElement = "propertyOrValue";
    }
    return propertyOrValue;
})(element);

_md.propertyOrValue = propertyOrValue;
// element h1
...
_md.ref = ref;
_md.__tagElementMapping = { '@': 'propertyOrValue', '+': 'code', 'r-a': 'aRef', 'ra': 'aRef', 'r-img': 'imgRef', 'rimg': 'imgRef' };
