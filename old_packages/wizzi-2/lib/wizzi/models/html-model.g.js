...
var element = (function (htmlBase) {
    ...
    element.prototype.loadChild = function(child) {
        ...
        if (_l == 1 && _ch == '#') {
            if (name === '#') {
                return this.wzLoadToChildColl(child, md._sharp, this.elements);
            }
        }
        if (_l == 1 && _ch == '+') {
            if (name === '+') {
                return this.wzLoadToChildColl(child, md._text, this.elements);
            }
        }
        if (_l == 1 && _ch == '-') {
            if (name === '-') {
                return this.wzLoadToChildColl(child, md.comment, this.elements);
            }
        }
        if (_l == 1 && _ch == '.') {
            if (name === '.') {
                return this.wzLoadToChildColl(child, md._dot, this.elements);
            }
        }
        if (_l == 1 && _ch == '<') {
            if (name === '<') {
        ...
        if (_l == 1 && _ch == 'q') {
            if (name === 'q') {
                return this.wzLoadToChildColl(child, md.q, this.elements);
            }
        }
        if (_l == 1 && _ch == 's') {
            if (name === 's') {
                return this.wzLoadToChildColl(child, md.s, this.elements);
            }
        }
        if (_l == 1 && _ch == 'u') {
            if (name === 'u') {
                return this.wzLoadToChildColl(child, md.u, this.elements);
            }
        }
        if (_l == 2 && _ch == '+') {
            if (name === '++') {
                return this.wzLoadToChildColl(child, md._textLF, this.elements);
            }
        }
        if (_l == 2 && _ch == 'b') {
            if (name === 'br') {
        ...
        if (_l == 2 && _ch == 'd') {
            if (name === 'dd') {
                return this.wzLoadToChildColl(child, md.dd, this.elements);
            }
            else if (name === 'dl') {
                return this.wzLoadToChildColl(child, md.dl, this.elements);
            }
            else if (name === 'dt') {
                return this.wzLoadToChildColl(child, md.dt, this.elements);
            }
        }
        if (_l == 2 && _ch == 'e') {
            if (name === 'em') {
                return this.wzLoadToChildColl(child, md.em, this.elements);
            }
        }
        if (_l == 2 && _ch == 'h') {
            if (name === 'h1') {
        ...
        if (_l == 2 && _ch == 'j') {
            if (name === 'js') {
                return this.wzLoadToChildColl(child, md._js, this.elements);
            }
        }
        if (_l == 2 && _ch == 'l') {
            if (name === 'li') {
        ...
        if (_l == 2 && _ch == 'r') {
            if (name === 'rb') {
                return this.wzLoadToChildColl(child, md.rb, this.elements);
            }
            else if (name === 'rp') {
                return this.wzLoadToChildColl(child, md.rp, this.elements);
            }
            else if (name === 'rt') {
                return this.wzLoadToChildColl(child, md.rt, this.elements);
            }
        }
        if (_l == 2 && _ch == 't') {
            if (name === 'td') {
        ...
        if (_l == 3 && _ch == 'b') {
            if (name === 'bdi') {
                return this.wzLoadToChildColl(child, md.bdi, this.elements);
            }
            else if (name === 'bdo') {
                return this.wzLoadToChildColl(child, md.bdo, this.elements);
            }
        }
        if (_l == 3 && _ch == 'c') {
            if (name === 'col') {
                return this.wzLoadToChildColl(child, md.col, this.elements);
            }
            else if (name === 'css') {
                return this.wzLoadToChildColl(child, md._css, this.elements);
            }
        }
        if (_l == 3 && _ch == 'd') {
            if (name === 'dir') {
                ...
                return this.wzLoadToChildColl(child, md.del, this.elements);
            }
            else if (name === 'dfn') {
                return this.wzLoadToChildColl(child, md.dfn, this.elements);
            }
            else if (name === 'div') {
                return this.wzLoadToChildColl(child, md.div, this.elements);
            }
        }
        if (_l == 3 && _ch == 'i') {
            if (name === 'img') {
                ...
                return this.wzLoadToChildColl(child, md.ins, this.elements);
            }
        }
        if (_l == 3 && _ch == 'k') {
            if (name === 'kbd') {
                return this.wzLoadToChildColl(child, md.kbd, this.elements);
            }
        }
        if (_l == 3 && _ch == 'm') {
            if (name === 'map') {
                return this.wzLoadToChildColl(child, md.map, this.elements);
            }
        }
        if (_l == 3 && _ch == 'n') {
            if (name === 'nav') {
                return this.wzLoadToChildColl(child, md.nav, this.elements);
            }
        }
        if (_l == 3 && _ch == 'p') {
            if (name === 'pre') {
                return this.wzLoadToChildColl(child, md.pre, this.elements);
            }
        }
        if (_l == 3 && _ch == 'r') {
            if (name === 'rtc') {
                return this.wzLoadToChildColl(child, md.rtc, this.elements);
            }
            else if (name === 'rub') {
                return this.wzLoadToChildColl(child, md.rub, this.elements);
            }
        }
        if (_l == 3 && _ch == 's') {
            if (name === 'sub') {
                return this.wzLoadToChildColl(child, md.sub, this.elements);
            }
            else if (name === 'sup') {
                return this.wzLoadToChildColl(child, md.sup, this.elements);
            }
            else if (name === 'svg') {
                return this.wzLoadToChildColl(child, md.svg, this.elements);
            }
        }
        if (_l == 3 && _ch == 'v') {
            if (name === 'var') {
                return this.wzLoadToChildColl(child, md.xvar, this.elements);
            }
        }
        if (_l == 3 && _ch == 'w') {
            if (name === 'wbr') {
                return this.wzLoadToChildColl(child, md.wbr, this.elements);
            }
        }
        if (_l == 4 && _ch == 'a') {
            if (name === 'abbr') {
                return this.wzLoadToChildColl(child, md.abbr, this.elements);
            }
            else if (name === 'area') {
                return this.wzLoadToChildColl(child, md.area, this.elements);
            }
        }
        if (_l == 4 && _ch == 'b') {
            if (name === 'base') {
                return this.wzLoadToChildColl(child, md.base, this.elements);
            }
            else if (name === 'body') {
                return this.wzLoadToChildColl(child, md.body, this.elements);
            }
        }
        if (_l == 4 && _ch == 'c') {
            if (name === 'cite') {
                return this.wzLoadToChildColl(child, md.cite, this.elements);
            }
            else if (name === 'code') {
        ...
        if (_l == 4 && _ch == 'd') {
            if (name === 'data') {
                return this.wzLoadToChildColl(child, md.data, this.elements);
            }
        }
        if (_l == 4 && _ch == 'f') {
            if (name === 'form') {
                return this.wzLoadToChildColl(child, md.form, this.elements);
            }
        }
        if (_l == 4 && _ch == 'h') {
            if (name === 'html') {
                return this.wzLoadToChildColl(child, md.html, this.elements);
            }
            else if (name === 'head') {
                return this.wzLoadToChildColl(child, md.head, this.elements);
            }
        }
        if (_l == 4 && _ch == 'l') {
            if (name === 'lang') {
                ...
                return this.wzLoadToChildColl(child, md.link, this.elements);
            }
        }
        if (_l == 4 && _ch == 'm') {
            if (name === 'main') {
                return this.wzLoadToChildColl(child, md.main, this.elements);
            }
            else if (name === 'mark') {
                return this.wzLoadToChildColl(child, md.mark, this.elements);
            }
            else if (name === 'math') {
                return this.wzLoadToChildColl(child, md.math, this.elements);
            }
            else if (name === 'menu') {
                return this.wzLoadToChildColl(child, md.menu, this.elements);
            }
            else if (name === 'meta') {
                return this.wzLoadToChildColl(child, md.meta, this.elements);
            }
        }
        if (_l == 4 && _ch == 'r') {
            if (name === 'role') {
        ...
        if (_l == 4 && _ch == 's') {
            if (name === 'samp') {
                return this.wzLoadToChildColl(child, md.samp, this.elements);
            }
            else if (name === 'span') {
        ...
        if (_l == 4 && _ch == 't') {
            if (name === 'time') {
                return this.wzLoadToChildColl(child, md.time, this.elements);
            }
        }
        if (_l == 5 && _ch == 'a') {
            if (name === 'aside') {
                return this.wzLoadToChildColl(child, md.aside, this.elements);
            }
            else if (name === 'audio') {
                return this.wzLoadToChildColl(child, md.audio, this.elements);
            }
        }
        if (_l == 5 && _ch == 'c') {
            if (name === 'class') {
        ...
        if (_l == 5 && _ch == 'e') {
            if (name === 'embed') {
                return this.wzLoadToChildColl(child, md.embed, this.elements);
            }
        }
        if (_l == 5 && _ch == 'i') {
            if (name === 'input') {
                return this.wzLoadToChildColl(child, md.input, this.elements);
            }
        }
        if (_l == 5 && _ch == 'l') {
            if (name === 'label') {
                return this.wzLoadToChildColl(child, md.label, this.elements);
            }
        }
        if (_l == 5 && _ch == 'm') {
            if (name === 'meter') {
                return this.wzLoadToChildColl(child, md.meter, this.elements);
            }
        }
        if (_l == 5 && _ch == 'p') {
            if (name === 'param') {
                return this.wzLoadToChildColl(child, md.param, this.elements);
            }
        }
        if (_l == 5 && _ch == 'r') {
            if (name === 'ready') {
                return this.wzLoadToChildColl(child, md.ready, this.elements);
            }
        }
        if (_l == 5 && _ch == 's') {
            if (name === 'style') {
                ...
                return this.wzLoadToChildColl(child, md.small, this.elements);
            }
        }
        if (_l == 5 && _ch == 't') {
            if (name === 'title') {
                ...
                return this.wzLoadToChildColl(child, md.tfoot, this.elements);
            }
            else if (name === 'thead') {
                return this.wzLoadToChildColl(child, md.thead, this.elements);
            }
            else if (name === 'track') {
                return this.wzLoadToChildColl(child, md.track, this.elements);
            }
        }
        if (_l == 5 && _ch == 'v') {
            if (name === 'video') {
        ...
        if (_l == 6 && _ch == '@') {
            if (name === '@title') {
                return this.wzLoadToChildColl(child, md._title, this.elements);
            }
            else if (name === '@style') {
                return this.wzLoadToChildColl(child, md._style, this.elements);
            }
        }
        if (_l == 6 && _ch == 'b') {
            if (name === 'button') {
                return this.wzLoadToChildColl(child, md.button, this.elements);
            }
        }
        if (_l == 6 && _ch == 'c') {
            if (name === 'canvas') {
                return this.wzLoadToChildColl(child, md.canvas, this.elements);
            }
        }
        if (_l == 6 && _ch == 'd') {
            if (name === 'dialog') {
                return this.wzLoadToChildColl(child, md.dialog, this.elements);
            }
        }
        if (_l == 6 && _ch == 'f') {
            if (name === 'figure') {
                return this.wzLoadToChildColl(child, md.figure, this.elements);
            }
            else if (name === 'footer') {
                return this.wzLoadToChildColl(child, md.footer, this.elements);
            }
        }
        if (_l == 6 && _ch == 'h') {
            if (name === 'hidden') {
                ...
                return this.wzLoadToChildColl(child, md.header, this.elements);
            }
        }
        if (_l == 6 && _ch == 'i') {
            if (name === 'itemid') {
                ...
                return this.wzLoadToChildColl(child, md.iframe, this.elements);
            }
        }
        if (_l == 6 && _ch == 'k') {
            if (name === 'keygen') {
                return this.wzLoadToChildColl(child, md.keygen, this.elements);
            }
        }
        if (_l == 6 && _ch == 'l') {
            if (name === 'legend') {
                return this.wzLoadToChildColl(child, md.legend, this.elements);
            }
        }
        if (_l == 6 && _ch == 'o') {
            if (name === 'object') {
                return this.wzLoadToChildColl(child, md.object, this.elements);
            }
            else if (name === 'option') {
                return this.wzLoadToChildColl(child, md.option, this.elements);
            }
            else if (name === 'output') {
                return this.wzLoadToChildColl(child, md.output, this.elements);
            }
        }
        if (_l == 6 && _ch == 's') {
            if (name === 'script') {
                return this.wzLoadToChildColl(child, md.script, this.elements);
            }
            else if (name === 'select') {
                return this.wzLoadToChildColl(child, md.select, this.elements);
            }
            else if (name === 'source') {
                return this.wzLoadToChildColl(child, md.source, this.elements);
            }
            else if (name === 'strong') {
                return this.wzLoadToChildColl(child, md.strong, this.elements);
            }
        }
        if (_l == 7 && _ch == 'a') {
            if (name === 'address') {
                return this.wzLoadToChildColl(child, md.address, this.elements);
            }
            else if (name === 'article') {
                return this.wzLoadToChildColl(child, md.article, this.elements);
            }
        }
        if (_l == 7 && _ch == 'c') {
            if (name === 'caption') {
                return this.wzLoadToChildColl(child, md.caption, this.elements);
            }
        }
        if (_l == 7 && _ch == 'd') {
            if (name === 'details') {
                return this.wzLoadToChildColl(child, md.details, this.elements);
            }
        }
        if (_l == 7 && _ch == 'i') {
            if (name === 'itemref') {
        ...
        if (_l == 7 && _ch == 's') {
            if (name === 'section') {
                return this.wzLoadToChildColl(child, md.section, this.elements);
            }
            else if (name === 'summary') {
                return this.wzLoadToChildColl(child, md.summary, this.elements);
            }
        }
        if (_l == 8 && _ch == 'c') {
            if (name === 'colgroup') {
                return this.wzLoadToChildColl(child, md.colgroup, this.elements);
            }
        }
        if (_l == 8 && _ch == 'd') {
            if (name === 'dropzone') {
                ...
                return this.wzLoadToChildColl(child, md.datalist, this.elements);
            }
        }
        if (_l == 8 && _ch == 'f') {
            if (name === 'fieldset') {
                return this.wzLoadToChildColl(child, md.fieldset, this.elements);
            }
        }
        if (_l == 8 && _ch == 'i') {
            if (name === 'itemprop') {
        ...
        if (_l == 8 && _ch == 'm') {
            if (name === 'menuitem') {
                return this.wzLoadToChildColl(child, md.menuitem, this.elements);
            }
        }
        if (_l == 8 && _ch == 'n') {
            if (name === 'noscript') {
                return this.wzLoadToChildColl(child, md.noscript, this.elements);
            }
        }
        if (_l == 8 && _ch == 'o') {
            if (name === 'optgroup') {
                return this.wzLoadToChildColl(child, md.optgroup, this.elements);
            }
        }
        if (_l == 8 && _ch == 'p') {
            if (name === 'progress') {
                return this.wzLoadToChildColl(child, md.progress, this.elements);
            }
        }
        if (_l == 8 && _ch == 't') {
            if (name === 'tabindex') {
                ...
                return this.wzLoadToChildColl(child, md.template, this.elements);
            }
            else if (name === 'textarea') {
                return this.wzLoadToChildColl(child, md.textarea, this.elements);
            }
        }
        if (_l == 9 && _ch == 'a') {
            if (name === 'accesskey') {
        ...
        if (_l == 10 && _ch == 'b') {
            if (name === 'blockquote') {
                return this.wzLoadToChildColl(child, md.blockquote, this.elements);
            }
        }
        if (_l == 10 && _ch == 'f') {
            if (name === 'figcaption') {
                return this.wzLoadToChildColl(child, md.figcaption, this.elements);
            }
        }
        if (_l == 10 && _ch == 's') {
            if (name === 'spellcheck') {
    ...
    element.prototype.loadFromNode = function(node) {
        ...
        for (i=0; i<i_len; i++) {
            ...
            if (!loaded) {
                throw new md.htmlException("Tag not recognized: " + item.n, item, this);
            }
        }
    }
    element.prototype.wzVerify = function(ctx) {
        ...
        md.htmlBase.prototype.wzVerify.call(this, ctx);
    }
    element.prototype.wzInitialize = function(ctx) {
        ...
        md.htmlBase.prototype.wzInitialize.call(this, ctx);
    }
    return element;
})(htmlBase);
...
var html = (function (element) {
    ...
    html.prototype.wzVerify = function(ctx) {
        ...
        md.element.prototype.wzVerify.call(this, ctx);
    }
    return html;
})(element);
...
var _js = (function (element) {
    ...
    _js.prototype.wzInitialize = function(ctx) {
        ...
        md.element.prototype.wzInitialize.call(this, ctx);
    }
    return _js;
})(element);
...
md._style = _style;
md.__tagElementMapping = { '@': 'attribute', '<': 'element', 'var': 'xvar', '.': '_dot', '#': '_sharp', 'js': '_js', 'css': '_css', '+': '_text', '++': '_textLF', '-': 'comment', '@title': '_title', '@style': '_style', 'function': 'xfunction', '_': 'call', 'if': 'xif', 'else': 'xelse', 'for': 'xfor', 'while': 'xwhile', 'try': 'xtry', 'catch': 'xcatch', '{': 'jsObject', '[': 'jsArray' };
var htmlException = (function () {
    function htmlException(message,node,instance) {
        _classCallCheck(this, htmlException);
...
md.htmlException = htmlException;
