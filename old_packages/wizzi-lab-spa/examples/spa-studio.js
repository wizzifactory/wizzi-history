/*
    ...
    primary source IttfDocument: c:\my\wizzi\v2\sources\plugins\wizzi-lab-spa\ittf\examples\spa-studio.js.ittf
...
md.execute = function() {
    md.executeWizziFactoryJob(path.join(__dirname, 'spa', 'studio', 'studio.wfjob.ittf')
    , [
