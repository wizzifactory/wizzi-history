/*
    ...
    primary source IttfDocument: c:\my\wizzi\v2\sources\plugins\wizzi-lab-spa\ittf\examples\spa-black-triangle.js.ittf
...
md.execute = function() {
    md.executeWizziFactoryJob(path.join(__dirname, 'spa', 'black-triangle', 'black-triangle.wfjob.ittf')
    , [
